...
var X=(e,t,o)=>new Promise((n,s)=>{var a=u=>{try{d(o.next(u));}catch($){s($);}},i=u=>{try{d(o.throw(u));}catch($){s($);}},d=u=>u.done?n(u.value):Promise.resolve(u.value).then(a,i);d((o=o.apply(e,t)).next());});function K(){let e=['import XXXXXPage from "./screens/XXXXX/XXXXX"','import EditXXXXXPage from "./screens/XXXXX/EditXXXXX"','import CreateXXXXXPage from "./screens/XXXXX/CreateXXXXX"','<Route path="xxxxx" element={<XXXXXPage />} />','<Route path="xxxxx/create" element={<CreateXXXXXPage />} />','<Route path="xxxxx/edit/:id" element={<EditXXXXXPage />} />'];y.removeSync("./.git"),y.removeSync("./yarn.lock"),y.removeSync("./src/screens/XXXXX"),y.removeSync("./src/types/xxxxx.d.ts");let n=y.readFileSync("./src/main.tsx").toString().split(`
`).filter(s=>e.filter(a=>s.includes(a)).length===0);y.writeFileSync("./src/main.tsx",n.join(`
...
></Column>`;var B=de({color:"blue",indent:2});function Y(e,t){return X(this,null,function*(){let o="",n="",s=[],a=[],i=[],d=[],u=["InputSwitch"];t.crudFields.forEach((r,v)=>{let f="",b="";switch(r.required&&!u.includes(r.type)&&s.push(r.name),r.type){case"InputText":r.tableDisplay&&i.push(P(r.name)),a.push(ie(r)),f="string",b='""';break;case"InputTextarea":r.tableDisplay&&i.push(P(r.name)),a.push(ae(r)),f="string",b='""';break;case"InputNumber":r.tableDisplay&&i.push(P(r.name)),a.push(se(r)),f="number",b="0";break;case"Dropdown":r.tableDisplay&&i.push(P(r.name)),a.push(ce(r)),d.push({fieldName:r.name,options:r.options||[]}),f="string",b='""';break;case"RadioButton":r.tableDisplay&&i.push(P(r.name)),a.push(pe(r,r.options||[])),f="string",b='""';break;case"InputSwitch":r.tableDisplay&&i.push(P(r.name)),a.push(le(r)),f="boolean",b="false";break}v===0&&(o+=`  id?: string;
`,n+=`  id: "",
`),o+=`  ${r.name}: ${f};
`,n+=`  ${r.name}: ${b},
`,v===t.crudFields.length-1&&(o+=`}
`,n+=`};
`);});let $=`./src/screens/${e}`,F=`${$}/${e}.tsx`,k=`${$}/Create${e}.tsx`,W=`${$}/Edit${e}.tsx`,U="./src/layout/items.json",Z=y.readFileSync(`${l}/webapp/XXXXX.tsx`).toString(),G=y.readFileSync(`${l}/webapp/CreateXXXXX.tsx`).toString(),H=y.readFileSync(`${l}/webapp/EditXXXXX.tsx`).toString(),p=y.readFileSync(`${l}/webapp/xxxxx.d.ts`).toString(),w=Z.replace(/XXXXX/g,e).replace(/xxxxx/g,e.toLowerCase()),m=[];w.split(`
...
`));let fe=G.replace(/XXXXX/g,e).replace(/xxxxx/g,e.toLowerCase()).replace(/INPUT\-FIELDS/g,a.join(`
...
`));let xe=H.replace(/XXXXX/g,e).replace(/xxxxx/g,e.toLowerCase()).replace(/INPUT\-FIELDS/g,a.join(`
...
`));let Fe=y.readFileSync(U),re=JSON.parse(Fe.toString());re[0].items.push({label:e,to:`/${e.toLowerCase()}`}),y.writeFileSync(U,JSON.stringify(re,null,2)),B.start(`Creating types/${e.toLowerCase()}.d.ts`);let Ce=p.replace(/XXXXX/g,e).split(`
`)[0]+`
`+o;y.writeFileSync(`./src/types/${e.toLowerCase()}.d.ts`,Ce),B.succeed(`Created ${T.cyan(`types/${e}.d.ts`)}`),B.start(`Creating route for ${e}`);let we=y.readFileSync("./src/main.tsx").toString().split(`
`),ve=[`      <Route path="${e.toLowerCase()}" element={<${e}Page />} />`,`      <Route path="${e.toLowerCase()}/create" element={<Create${e}Page />} />`,`      <Route path="${e.toLowerCase()}/edit/:id" element={<Edit${e}Page />} />`],Se=[`import ${e}Page from "./screens/${e}/${e}"`,`import Edit${e}Page from "./screens/${e}/Edit${e}"`,`import Create${e}Page from "./screens/${e}/Create${e}"`],q=[];q.push(...Se),we.forEach(r=>{r.includes("</Route>")&&ve.forEach(v=>{q.push(v);}),q.push(r);}),y.writeFileSync("./src/main.tsx",q.join(`
`)),B.succeed(`Created route: ${T.cyan(`/${e.toLowerCase()}`)}`);})}var me=z$1.object({backendUrl:z$1.string().optional().default("http://localhost:3000"),screens:z$1.array(z$1.object({name:z$1.string(),url:z$1.string(),collectionName:z$1.string(),crudFields:z$1.array(z$1.object({name:z$1.string(),required:z$1.boolean().optional().default(!0),tableDisplay:z$1.boolean().optional().default(!0),inline:z$1.boolean().optional().default(!1),type:z$1.union([z$1.literal("InputText"),z$1.literal("InputTextarea"),z$1.literal("InputNumber"),z$1.literal("Dropdown"),z$1.literal("RadioButton"),z$1.literal("InputSwitch")]),options:z$1.array(z$1.object({name:z$1.string(),value:z$1.string()})).optional()}))}))});var J=(e=process.cwd())=>y.readdirSync(e).includes("kit.config.json"),A=(e,t)=>X(void 0,null,function*(){let o=process.cwd().split("/").at(-1),n;return o===e||J()&&e==="root"?n=yield t():J()?(process.chdir(e),n=yield t(),process.chdir("..")):e==="root"?(process.chdir(".."),n=yield t(),process.chdir(o)):(process.chdir(".."),process.chdir(e),n=yield t(),process.chdir(".."),process.chdir(o)),n}),O=(e,t)=>{let o=process.cwd().split("/").at(-1),n;return o===e||J()&&e==="root"?n=t():J()?(process.chdir(e),n=t(),process.chdir("..")):e==="root"?(process.chdir(".."),n=t(),process.chdir(o)):(process.chdir(".."),process.chdir(e),n=t(),process.chdir(".."),process.chdir(o)),n};var L=()=>O("root",()=>{if(!y.existsSync("kit.config.json"))return null;let t=JSON.parse(y.readFileSync("kit.config.json").toString());return me.parse(t)});function Q(e,t){return X(this,null,function*(){let o=[],n=[],s=[],a=[];t.crudFields.forEach(({name:p,type:w,required:m})=>{o.push(`${p}: entity.${p},`),w==="InputText"||w==="InputTextarea"||w==="Dropdown"||w==="RadioButton"?(n.push(`${p}${m?"":"?"}: string;`),s.push(`${p}: { type: String, required: ${m} },`),a.push(`${p}: z.string()${m?".nonempty()":".optional()"},`)):w==="InputNumber"?(n.push(`${p}${m?"":"?"}: number;`),s.push(`${p}: { type: Number, required: ${m} },`),a.push(`${p}: z.number()${m?"":".optional()"},`)):w==="InputSwitch"&&(n.push(`${p}${m?"":"?"}: boolean;`),s.push(`${p}: { type: Boolean, required: ${m} },`),a.push(`${p}: z.boolean()${m?"":".optional()"},`));});let i=`./src/Microservices/${e}`,d=y.readFileSync(`${l}/server/XXXXXController.ts`).toString().replace(/XXXXX/g,e).replace(/xxxxx/g,e.toLowerCase()).replace("/*INTERFACE_FIELDS*/",n.join(`
`)).replace("/*SCHEMA_FIELDS*/",s.join(`
`)).replace("/*ENTITY_FIELDS*/",o.join(`
`)).replace("/*ZOD_FIELDS*/",a.join(`
...
`);y.writeFileSync("./src/Microservices/ApiRouter.ts",H);})}var _=de({color:"blue",indent:2}),N=de({color:"blue",indent:2});function M(e){return X(this,null,function*(){var s,a;let t=e.toLowerCase(),o=(a=(s=L())==null?void 0:s.screens)==null?void 0:a.find(i=>i.name.toLowerCase()===t.toLowerCase());if(!o){_.fail(`Screen ${T.cyan(t)} not found in config file`);return}let n=t.charAt(0).toUpperCase()+t.slice(1);yield A("webapp",()=>X(this,null,function*(){_.start(`Creating screen: ${T.cyan(n)}`);let i=`./src/screens/${n}`;if(y.existsSync(i)){_.fail(`Screen ${T.cyan(n)} already exists`);return}let d=`${i}/${n}.tsx`,u=`${i}/Create${n}.tsx`,$=`${i}/Edit${n}.tsx`,F=`./src/types/${n.toLowerCase()}.d.ts`;y.createFileSync(d),y.createFileSync(u),y.createFileSync($),y.createFileSync(F),yield Y(n,o),_.succeed(`Created screen: ${T.cyan(n)}`);})),yield A("server",()=>X(this,null,function*(){N.start(`Creating CRUD for: ${T.cyan(n)}`);let i=`./src/Microservices/${n}`;if(y.existsSync(i)){N.fail(`CRUD for ${T.cyan(n)} already exists`);return}let d=`${i}/${n}Controller.ts`,u=`${i}/${n}Router.ts`,$=`${i}/${n}.dto.ts`;y.createFileSync(d),y.createFileSync(u),y.createFileSync($),yield Q(n,o),N.succeed(`Created CRUD for: ${T.cyan(n)}`);}));})}function z(){return X(this,null,function*(){var e;K(),(e=L())==null||e.screens.map(t=>{M(t.name);});})}var $e=de({color:"blue",indent:2});function ee(e){A("webapp",()=>X(this,null,function*(){let t=e.charAt(0).toUpperCase()+e.slice(1);$e.start(`Removing screen: ${e}`);let o=`./src/types/${e}.d.ts`,n=`./src/screens/${t}`,s="./src/layout/items.json",a=y.readFileSync(s),i=JSON.parse(a.toString());i[0].items=i[0].items.filter(F=>F.label.toLowerCase()!==t.toLowerCase()),y.writeFileSync(s,JSON.stringify(i,null,2)),y.removeSync(o),y.removeSync(n);let d=[`<Route path="${t.toLowerCase()}" element={<${t}Page />} />`,`<Route path="${t.toLowerCase()}/create" element={<Create${t}Page />} />`,`<Route path="${t.toLowerCase()}/edit/:id" element={<Edit${t}Page />} />`,`import ${t}Page from "./screens/${t}/${t}"`,`import Edit${t}Page from "./screens/${t}/Edit${t}"`,`import Create${t}Page from "./screens/${t}/Create${t}"`],$=y.readFileSync("./src/main.tsx").toString().split(`
